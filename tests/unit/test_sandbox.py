...
def test_execute_code_success(mock_sandbox_class):
...
@pytest.mark.unit
@patch("app.services.sandbox.SandboxSession")
def test_execute_code_with_libraries(mock_sandbox_class):
...
@pytest.mark.unit
@patch("app.services.sandbox.SandboxSession")
def test_execute_code_cleanup_on_error(mock_sandbox_class):
...
@pytest.mark.unit
@patch("app.services.sandbox.SandboxSession")
def test_execute_code_cleanup_on_close_error(mock_sandbox_class):
