...
def test_create_session(mock_sandbox_cls, session_manager):
...
@pytest.mark.unit
@patch("app.services.session_manager.SandboxSession")
def test_close_session(mock_sandbox_cls, session_manager):
...
@pytest.mark.unit
def test_close_session_not_found(session_manager):
...
@pytest.mark.unit
@patch("app.services.session_manager.SandboxSession")
def test_list_sessions(mock_sandbox_cls, session_manager):
